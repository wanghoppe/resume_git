...
\phone[mobile]{(+1) 236-862-2640}                   % optional, remove / comment the line if not wanted            % optional, remove / comment the line if not wanted
%\phone[fax]{+3~(456)~789~012}                      % optional, remove / comment the line if not wanted
\email{hwa125@sfu.a}                               % optional, remove / comment the line if not wanted
